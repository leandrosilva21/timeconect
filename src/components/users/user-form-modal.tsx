      ...
      <div className="p-5 max-h-[90vh] overflow-y-auto space-y-4">
        ...
        {form.profiles.length > 0 && (
          <>
            ...
            {/* ── Funcionário NFeconnect (separa do resultado HD Think no fechamento) ── */}
            {isConsultor && (
              <Toggle
                value={form.is_bizify}
                onChange={() => setForm(f => ({ ...f, is_bizify: !f.is_bizify }))}
                label="Funcionário NFeconnect (sai dos cards HD Think e vai pra aba NFeconnect no fechamento)"
              />
            )}

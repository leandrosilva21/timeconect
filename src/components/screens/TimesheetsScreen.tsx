          ...
          {cells.map((day, i) => {
            ...
            return (
              <button key={i} type="button"
                ...
                style={{
                  background: s || e ? 'var(--brand-primary)' : ir ? 'rgba(251, 146, 60,0.15)' : undefined,
      ...
      <div className={embedded ? 'min-w-0' : 'max-w-7xl mx-auto min-w-0'}>
        ...
        {isCliente && (
          <div className="flex items-start gap-2.5 px-4 py-3 rounded-xl mb-4 text-xs"
            style={{ background: 'rgba(251, 146, 60,0.06)', border: '1px solid rgba(251, 146, 60,0.18)', color: 'var(--brand-muted)' }}>

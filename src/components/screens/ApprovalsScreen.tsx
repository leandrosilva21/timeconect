...
export interface ApprovalsScreenProps {
  /**
   * Quando setado, restringe os dados aos projetos elegíveis do Portal de
   * Sustentação (filtro de service_type + regra de override de coordenador).
   */
  scope?: 'sustentacao'
  /**
   * Esconde o título "Aprovações" — útil quando a tela está aninhada em
   * outro container que já tem cabeçalho próprio (ex.: Portal de Sustentação).
   */
  embedded?: boolean
}

...
interface Props {
  /**
   * Restringe a busca aos projetos elegíveis ao Portal de Sustentação
   * (filtro de service_type + regra de override de coordenador no backend).
   */
  scope?: 'sustentacao'
  /**
   * Quando true, esconde o PageHeader (a tela está aninhada em outra que já
   * tem cabeçalho próprio — ex.: dentro do Portal de Sustentação).
   */
  embedded?: boolean
}

export function AuditoriaApontamentosScreen({ scope, embedded }: Props) {

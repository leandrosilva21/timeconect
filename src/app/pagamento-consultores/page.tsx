...
function SummaryCard({ label, value, sub, icon: Icon, accent }: {
  ...
  const color = accent === 'primary' ? '#FB923C' : accent === 'success' ? '#10B981' : '#F59E0B'
  const bg = accent === 'primary' ? 'rgba(251, 146, 60,0.08)' : accent === 'success' ? 'rgba(16,185,129,0.10)' : 'rgba(245,158,11,0.10)'
  return (

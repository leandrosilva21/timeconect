          ...
          <div className="max-h-52 overflow-y-auto py-1">
            ...
            {filtered.map(o => (
              <button
                ...
                className="w-full text-left px-3 py-2 text-sm hover:bg-white/5 transition-colors"
                style={{ color: String(o.id) === value ? '#FB923C' : 'var(--brand-text)' }}
              >
                {o.name}
              </button>
            ))}
...
function SummaryCard({ label, value, sub, icon: Icon, accent }: {
  ...
  const color = accent === 'primary' ? '#FB923C' : accent === 'success' ? '#10B981' : accent === 'info' ? '#8B5CF6' : '#F59E0B'
  const bg = accent === 'primary' ? 'rgba(251, 146, 60,0.08)' : accent === 'success' ? 'rgba(16,185,129,0.10)' : accent === 'info' ? 'rgba(139,92,246,0.12)' : 'rgba(245,158,11,0.10)'
  return (
    <div
        ...
        <div className="flex rounded-xl border overflow-hidden text-sm w-fit"
          ...
          {([
            ...
            <button
              ...
              style={{
                background: mainTab === val ? 'rgba(251, 146, 60,0.12)' : 'transparent',
              ...
              <div className="flex rounded-xl border overflow-hidden text-sm"
                ...
                {([
                  ...
                  <button
                    ...
                    style={{
                      background: paidFilter === val ? 'rgba(251, 146, 60,0.12)' : 'transparent',
              ...
              <div className="flex rounded-xl border overflow-hidden text-sm"
                ...
                {([
                  ...
                  <button
                    ...
                    className="px-4 py-2 font-medium transition-colors"
                    style={{
                      background: statusFilter === val ? 'rgba(251, 146, 60,0.12)' : 'transparent',

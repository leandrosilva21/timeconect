  ...
  if (loading || !user) {
    return (
      <div style={{ minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ width: 32, height: 32, borderRadius: '50%', border: '3px solid rgba(251, 146, 60,0.2)', borderTopColor: '#FB923C', animation: 'spin 0.8s linear infinite' }} />
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        <Link href="/mobile/apontamento" style={{ textDecoration: 'none' }}>
          ...
          >
            ...
            <div>
              <p style={{ fontSize: 18, fontWeight: 700, color: '#FB923C', margin: 0 }}>Apontamento</p>

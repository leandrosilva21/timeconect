    ...
    <AppLayout title="Saldo Inicial de Tickets">
      <div className="max-w-6xl mx-auto px-4 py-6 md:px-6 space-y-4">
        <header className="flex items-start gap-3">
          <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ background: 'rgba(251, 146, 60,0.08)' }}>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative rounded-2xl p-6 w-full max-w-md mx-4" style={{ background: '#111113', border: '1px solid #3f3f46' }}>
        ...
        <div className="space-y-3">
          ...
          {lookup?.customer && (
            <div className="rounded-lg px-3 py-2 text-xs" style={{ background: 'rgba(251, 146, 60,0.05)', border: '1px solid rgba(251, 146, 60,0.2)' }}>
